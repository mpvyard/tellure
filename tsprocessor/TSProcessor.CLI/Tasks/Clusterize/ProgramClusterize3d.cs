...
namespace TSProcessor.CLI.Tasks.Clusterize
{
    class ProgramClusterize3d
    {
        public static int Clusterize(ClusterizationOptions opts, ILogger logger)
        {
            ...
            //    dots.Add(var);
            //}
            Series3 series = new Series3(seriesParams, dots);
        ...
        private static void ClusterizeAllParallel(Series3 series, int[] from, int[] to, ILogger logger)
        {
        ...
        private static IEnumerable<ZVector> FindZVectors(Series3 series, int[] step, int firstNumber)
        {
